...
export const translations = {
  th: {
    ...
    paymentMethodLabel: 'เลือกช่องทางการชำระเงิน:',
    payMethodTransfer: '💳 โอนเงิน / สแกน QR (PromptPay / Transfer)',
    payMethodCash: '💵 ชำระด้วยเงินสด (Cash on Pick-up)',
    cashOnlyPickupNote: '🔒 การจัดส่งถึงบ้านต้องชำระเงินผ่าน QR Code / โอนเงินเท่านั้น',
    pickupOnlyTag: '(เฉพาะรับที่สโมสร)',
    cashNoticeTitle: '💵 ชำระเงินสดตอนมารับเสื้อ',
    cashNoticeDesc: 'กรุณาเตรียมเงินสดตามยอดชำระ และนำมาชำระ ณ ห้องสโมสรนักศึกษาเมื่อถึงกำหนดวันรับเสื้อ (ไม่ต้องแนบสลิปโอนเงิน)',
    cashAmountDue: 'ยอดเงินสดที่ต้องชำระ:',
  ...
  en: {
    ...
    payMethodTransfer: '💳 Bank Transfer / PromptPay QR',
    payMethodCash: '💵 Pay with Cash on Pick-up',
    cashOnlyPickupNote: '🔒 Home delivery requires payment via QR Code / Bank Transfer only',
    pickupOnlyTag: '(Pick-up Only)',
    cashNoticeTitle: '💵 Cash Payment on Pick-up',
    cashNoticeDesc: 'Please prepare the exact cash amount and pay at the Student Union office when collecting your shirt (no slip upload required).',
    cashAmountDue: 'Cash Amount Due:',
  ...
  zh: {
    ...
    paymentTitle: '💳 付款方式与支付信息',
    paymentMethodLabel: '选择付款方式：',
    payMethodTransfer: '💳 扫码转账 / 手机银行 (QR / PromptPay)',
    payMethodCash: '💵 现场现金付款 (Cash on Pick-up)',
    cashOnlyPickupNote: '🔒 快递配送方式必须使用二维码或转账支付',
    pickupOnlyTag: '(仅限自取)',
    cashNoticeTitle: '💵 现场自取时以现金付款',
    cashNoticeDesc: '请备好相应数额现金，于公布的领取日期前往学生会办公室现场支付并领取短袖（无需上传转账凭证）。',
    cashAmountDue: '应付现金总额：',
    totalPayLabel: '应付金额：',
